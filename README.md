...
UTFool /pron. as <span style="background: linear-gradient(to bottom left,
transparent, transparent 48%, black 48%, black 52%, transparent 52%, transparent)">b</span>eautiful/ is a Unicode-based object-oriented
